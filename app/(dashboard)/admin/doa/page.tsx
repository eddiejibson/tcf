                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-white/40 text-xs">
                            {(() => {
                              const itemCount = claim.groups.reduce((n, g) => n + g.items.length, 0);
                      ...
                      {expandedClaims.has(claim.id) && (
                        <div className="px-6 pb-4">
                          ...
                          <div className="space-y-3">
                            {claim.groups.map((photoGroup) => (
                              <div key={photoGroup.id} className="bg-white/[0.03] rounded-xl p-3">
                                {photoGroup.imageUrls?.length > 0 && (
                                  <div className="flex gap-2 mb-3 flex-wrap">
                                    {photoGroup.imageUrls.map((url: string, i: number) => (
