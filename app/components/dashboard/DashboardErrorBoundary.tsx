...
export default class DashboardErrorBoundary extends Component<{ children: ReactNode }, State> {
      ...
      return (
        <div className="min-h-screen bg-[#1a1f26] flex items-center justify-center p-6">
          <div className="max-w-sm w-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] p-8 text-center">
            ...
            <p className="text-white/50 text-sm mb-6">This page encountered an error. Please reload to continue.</p>
            <button
              onClick={() => window.location.reload()}
              className="w-full py-3 bg-[#0984E3] hover:bg-[#0984E3]/90 text-white font-medium rounded-xl transition-all"
            >
              Reload Page
            </button>
          </div>
