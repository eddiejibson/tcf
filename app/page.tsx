...
export default function Home() {
  return (
    <div className="relative w-full bg-[#2B343E]">
      ...
      {/* ===== SLANT DIVIDER: Expertise to Source Map ===== */}
      <div className="relative h-16 md:h-24 overflow-hidden divider-texture">
        <svg
          className="absolute w-full h-full"
          viewBox="0 0 100 100"
      ...
      <section className="px-6 md:px-[100px] lg:px-[140px] py-16 md:py-24 bg-[#1a1f26] section-texture">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <SwipeReveal>
              <p className="text-[#0984E3] font-semibold text-sm tracking-widest uppercase mb-3">
      ...
      {/* ===== SLANT DIVIDER: Source Map to CTA ===== */}
      <div className="relative h-16 md:h-24 overflow-hidden bg-[#1a1f26] divider-texture">
        <svg
          className="absolute w-full h-full"
          viewBox="0 0 100 100"
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                {/* Instagram */}
                <a href="#" className="text-white/40 hover:text-[#0984E3] transition-colors">
