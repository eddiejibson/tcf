...
export class AddAwaitingPayment1773832311942 implements MigrationInterface {
    name = 'AddAwaitingPayment1773832311942'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."orders_status_enum" RENAME TO "orders_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('DRAFT', 'SUBMITTED', 'ACCEPTED', 'REJECTED', 'AWAITING_PAYMENT', 'PAID', 'EXPIRED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum_old" AS ENUM('DRAFT', 'SUBMITTED', 'ACCEPTED', 'REJECTED', 'PAID', 'EXPIRED')`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`);
